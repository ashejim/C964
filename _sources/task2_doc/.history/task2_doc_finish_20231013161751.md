...
If some or all of your application is online, then you should submit at least the minimal source files needed to recreate the project locally alon. For example, if the application
