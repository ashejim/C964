...
:::{warning}
As of 9/25/2023, C964 was updated from version 3 to version 4. Though the rubirc and task directions were reworded, **the actual requirements and their assessment criteria are unchanged.** Therefore, your best option for success is to follow the advice of your program mentor and refer to this website. Over the next month, this website will be revised to better align with version 4.
:::
