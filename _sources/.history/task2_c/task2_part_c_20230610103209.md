...
<!-- REVISIONS STOP HERE 6/9 11:45 am EST -->

<!--tab-item examples -->
`````{tab-set}
````{tab-item} Example 1
**The App:** A standalone [Jupyter Notebook](https://jupyter.org) file (.ipynb) which can predict Iris types (see the [example](file:///D:/OneDrive%20-%20Western%20Governors%20University/jupyter-books/C964/_build/html/task2_c/example_sup_class/sup_class_ex.html#example-supervised-classification-app)).
