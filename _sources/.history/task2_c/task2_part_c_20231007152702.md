...
As you might guess, this is a common issue. Many models and  datasets will exceed thhe 200 MB upload limit. But evaluators only need *access* to everything necessary to develop and run your project. 
