...
As you might guess, this is a common issue. But evaluators only need *access* to everything necessary to develop and run your project. Access to large files can be provided with a Dropbox link (say in your Google drive) -don't forget to set the share settings so they can access it!
