...
[some link](../tas)
<!-- example of link with help of marksman. edited to add rel path (..) and html (.md links dont get translated by JB apparently): This is [choosing a topic test](../task1.html#choosing-a-topic) -->
