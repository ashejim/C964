...
Yes. You can use any of your own academic or professional work for C964 including the C950 project (Data Structures & Algorithms II). However, C951 Tasks 1 (chat bot) and 2 (resccan be passed without applying a mathematically based algorithm which is necessary to pass C964. 
