...
For webpages or hosted Jupyer notebooks, submit the url link but also submit the html or .ipynb files. For large models, provide instructions and code to locally build the model and access to the data as 
