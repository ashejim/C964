...
Look for data which has mutualay exclusive categories which can used as a dependent variables,e.g., yes/no, alive/dead, blue/red/yellow, etc. See our supervised  
