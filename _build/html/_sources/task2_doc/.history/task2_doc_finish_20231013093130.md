...
2. Check adherence to APA formatting, particularly citations. Preserve the formatting of the template, and this won't be a problem. 
3. Export and submit as a single .pdf file. 
