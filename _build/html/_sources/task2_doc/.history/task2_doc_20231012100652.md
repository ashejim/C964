...
You can see which verison you are enrolled in by going to the 'Assessments' section of your C964 COS page.
![alt tex](./../url_images/C964_sim3-1.png)

For both versions, SIM2 and SIM3, we recommend using the most recent verion of the [Task 2 Template (new)]()following the advice on th
