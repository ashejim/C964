...
As regression models estimate a continuous values, they rarely exactly match actual values. Thus success of the model  Thus predictions rarely exactly match actual values, a   
