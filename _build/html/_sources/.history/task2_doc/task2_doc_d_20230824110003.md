...
For regression, a metric measuring the error of the model should be used. Unlike classification models, a regression estimates continuous values and regression metrics take different approaches to quantifying how 
