...
As regression models estimate a continuous values, they rarely exactly match actual values. Thus success of the model is measured by how closely prediction fits Thus predictions rarely exactly match actual values, a   
