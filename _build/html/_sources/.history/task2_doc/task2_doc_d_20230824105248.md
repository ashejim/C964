...
Though no minimal accuracy is required, your model should perform better than randomly selecting categories, e.g., the the model predicting flower 1 of 3 types should perform better than $\frac{1}{3} = 33.3\hat{3}\% $
