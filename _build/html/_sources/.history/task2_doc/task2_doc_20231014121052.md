...
:::{note}
The content here for parts A, B, and D aligns with the latest version of the Task 2 template. As the new tamplate it’s more succinct and clear, we recommend using this template for both SIM2 and SIM3. However, using the previous template is still acceptable.  
:::
