...
As you might guess, this is a common issue. Many models and datasets especially will exceed the 200 MB upload limit.

For 

But evaluators only need *access* to everything necessary to develop and run your project. 
