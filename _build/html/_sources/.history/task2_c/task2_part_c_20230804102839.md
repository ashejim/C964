...
Yes. You can use any of your own academic or professional work for C964 including the C950 project (Data Structures & Algorithms II). However, C951 Tasks 1 and 2 can be passed without apply does not require the use of algorithm which necessar 
