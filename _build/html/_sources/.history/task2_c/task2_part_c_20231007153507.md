...
For data public data links not modifiable by the student, it is acceptable to submit a link for the data source or have code import the data via a link. 
