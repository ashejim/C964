...
Look for data which has mutualay exclusive categories which can used as  the categories are mutually exclusive, e.g., yes/no, alive/dead, blue/red/yellow, etc. 
