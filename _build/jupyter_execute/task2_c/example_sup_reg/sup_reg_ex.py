...
# 
# For this example, we'll slightly modify the [previous example](sup_class_ex). Instead of predicting the category *type*, we'll predict the number *sepal-length*.  
