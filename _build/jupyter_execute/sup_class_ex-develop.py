...
# 
# Supervised algorithms use inputs (indpendent varaiables) and labeled outputs (dependent variable -the "answers") to create a model that can measure its performance and learn over time. Splitting the data into independent and dependent varaibles, we have the following:
