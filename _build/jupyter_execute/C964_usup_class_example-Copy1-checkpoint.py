...
# 
# We need to research a little to name these properly. Following [Iris flower data set](https://en.wikipedia.org/wiki/Iris_flower_data_set) we name the columns:
...
# Aesthetics are not assessed, bub Pandas visualizations are a bit limited compared to matplotlib. Below we get a much better picture of what's going on, and we can clealry see the three different types.
