...
The second requirement is to ensure there will ba a static record for evaluation. But you can still expect evaluators to view links representing the polished finished application.
