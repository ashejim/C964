...
```{note}
*All* dates must be in the future. Part B is a proposal. So Even if based on an already completed project, you should write task 2 as though it's yet to be done.
