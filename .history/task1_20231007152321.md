...
### Help, the rubric is confusing! The directions seem to require items outside the scope of the project, e.g., "implementation of interactive queries" and "hy The directions have parts A, B, C, and D, but the rubric has "Outcomes" 1-6. How do these align?
