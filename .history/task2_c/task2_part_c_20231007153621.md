...
For public data sets not modifiable by the student (e.g., data from Kaggle.com, ), it is acceptable to submit a link for the data source or have code import the data via a link. 
