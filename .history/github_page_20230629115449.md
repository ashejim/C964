...
3. A [Markdown](https://www.markdownguide.org/) editor.
4. A GitHub account and repository.
...
I use Visual Studio Code. It has lots of helpful extensions for Markdown and Jupyter. It does have some issues with "undoing" changes within Jupyter code cells, so don't forget to back up your work.

## Step 5. Turn your Markdown/Jupyter files into HTML

This is why we need Jupyter-book. Go to the folder where your Jupyter-book folder lives and type:

```shell
jupyter-book build mynewbook
```

And that's it. You now have the web files, locally. After building, you'll be provided with a local link. Copy and paste the link into your browser of choice to check it out.
