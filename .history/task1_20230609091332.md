...
2. Both or neither box is marked on the waiver form. Mark one and only one box. However, if the form isn't needed -you no longer need to submit it. See the [waiver form instructions](task1:waiver)
