...
:::{note}
That's all I have for this page for now. This page is still in development. However, there are few qualitative criteria by which these sections can be assessed. If the items in the template are addressed these sections are very rarely sent back. 
:::
